...
磁気光学カー効果顕微鏡（magneto-optical Kerr effect microscope, MOKE 顕微鏡）は、磁性体表面での反射光の偏光変化を利用して磁区構造や磁化反転過程を可視化する光学顕微鏡である。可視〜近赤外光を用いるため装置構成が比較的簡潔でありながら、薄膜磁性体や微細パターンの磁区観察・磁化ダイナミクス解析に高い有用性を持つ。
