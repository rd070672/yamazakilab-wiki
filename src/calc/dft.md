# 第一原理計算（ab initio）の基本原理：DFTを中心とした材料物性予測
...
## 2. 核と電子の分離：断熱近似と Born–Oppenheimer 近似
...
## 3. 密度汎関数理論（DFT）の基本：密度で基底状態を記述する
...
### 3.2 Kohn–Sham（KS）方程式：相互作用系を一電子問題に写像する
