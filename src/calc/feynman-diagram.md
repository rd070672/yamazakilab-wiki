...
### 1.2 Matsubara（虚時間）グリーン関数
熱平衡（温度 $T$、$\beta=1/k_B T$）では虚時間 $\tau\in[0,\beta)$ を導入し、虚時間順序化 $T_{\tau}$ により
$$
...
### 6.2 RPA（環状図の再和）と遮蔽
クーロン相互作用による基本の再和として RPA がある。バブルを鎖状に繋いだ環状図を再和すると
$$
